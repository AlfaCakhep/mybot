...
const starts = async (ikyy = new WAConnection()) => {
	...
	ikyy.browserDescription = ["ALFA - BOT", "Firefox", "3.0.0"];
	...
	ikyy.on('connecting', () => {
		console.log(color('[ ALFA GANS ]', 'cyan'), color('Menghubungkan....'));
	})

	//connect
	ikyy.on('open', () => {
		console.log(color('[ ALFA GANS ]', 'cyan'), color('Bot Sudah Online!'));
	})
